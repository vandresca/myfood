...
//Obtenemos los parametros GET de la url
$pass = $_GET['p'];
$user =$_GET['u'];


//Creamos la sql para modificar la contraseña del usuario
$sql = "UPDATE `User` SET `password`= '$pass' WHERE idUser= $user";

//Creamos un objeto para guardar el estado de la respuesta de la sql
$data = new stdClass();

//Ejecutamos la sql
$result = mysqli_query($con, $sql);

//Obtenemos el numero de filas que se han modificado al ejecuta la sql
